...
;; The Little Prover, chapter 6: every entry of the book's transcript for this chapter
...
;;
;; Run: wat books/little-prover/ch06-transcript.wat   (exit 0 and a final "ok" line = pass)
