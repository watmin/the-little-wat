...
;; replace, symm, trans, Either, left, right, ind-Either, Trivial, sole, Absurd, ind-Absurd,
...
;;             (VEither L R) (VLeft v) (VRight v) (VTrivial) (VSole) (VAbsurd) (VNeu type neutral)
...
;;             (NIndEither target L R motive base-left base-right) (NIndAbsurd target motive)
...
(:wat::core::defn :pie::eval-var [env <- :wat::WatAST name <- :wat::core::String] -> :wat::WatAST
  (:wat::core::cond
    ...
    ((:wat::core::= name "Trivial") (:pie::t0 "VTrivial"))
    ((:wat::core::= name "sole") (:pie::t0 "VSole"))
...
(:wat::core::defn :pie::eval-form [env <- :wat::WatAST e <- :wat::WatAST h <- :wat::core::String] -> :wat::WatAST
  (:wat::core::cond
    ...
    ((:wat::core::= h "ind-Absurd") (:pie::do-ind-absurd (:pie::eval env (:pie::arg e 0)) (:pie::eval env (:pie::arg e 1))))
    ...
    ((:wat::core::= h "ind-Vec")
      (:pie::do-ind-vec (:pie::eval env (:pie::arg e 0)) (:pie::eval env (:pie::arg e 1)) (:pie::eval env (:pie::arg e 2))
                        (:pie::eval env (:pie::arg e 3)) (:pie::eval env (:pie::arg e 4))))
...
;; cong, in core (cong target X Y f): (same x) gives (same (f x)); a stuck target, of type
;; (= X from to), gives a stuck cong of type (= Y (f from) (f to)).
(:wat::core::defn :pie::do-cong [t <- :wat::WatAST x <- :wat::WatAST y <- :wat::WatAST f <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::cond
    ((:pie::tag? t "VSame") (:pie::t1 "VSame" (:pie::do-ap f (:pie::arg t 0))))
    ((:pie::tag? t "VNeu")
...
;; ind-Absurd: an Absurd has no values, so its target is always stuck, and so is it.
(:wat::core::defn :pie::do-ind-absurd [t <- :wat::WatAST mot <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::if (:pie::tag? t "VNeu")
    (:pie::t2 "VNeu" mot (:pie::t2 "NIndAbsurd" (:pie::arg t 1) mot))
    (:pie::fail "ind-Absurd of a non-Absurd")))
...
;; ind-Vec, (ind-Vec len target mot base step): vecnil gives the base; (vec:: h t), of length
;; (add1 k), gives (step k h t (ind-Vec k t mot base step)). The type is (mot len target).
;; The motive's type (Pi ((k Nat)) (-> (Vec E k) U)) and the step's type
;; (Pi ((k Nat) (h E) (t (Vec E k))) (-> (mot k t) (mot (add1 k) (vec:: h t)))), as values.
(:wat::core::defn :pie::ind-vec-mot-type [et <- :wat::WatAST] -> :wat::WatAST
  (:pie::t3 "VPi" (:pie::sym "k") (:pie::t0 "VNat")
            (:pie::clos (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::sym "%E") et))))
                        "k"
                        (:pie::t2 "->" (:pie::t2 "Vec" (:pie::sym "%E") (:pie::sym "k")) (:pie::sym "U")))))

(:wat::core::defn :pie::ind-vec-step-type [et <- :wat::WatAST mot <- :wat::WatAST] -> :wat::WatAST
  (:pie::t3 "VPi" (:pie::sym "k") (:pie::t0 "VNat")
            (:pie::clos (:pie::mk (:wat::core::Vector :- [:wat::WatAST]
                        ...
                        (:pie::t2 "Pi"
                                  (:pie::mk (:wat::core::Vector :- [:wat::WatAST]
                                              (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::sym "h") (:pie::sym "%E")))
                                              (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::sym "t") (:pie::t2 "Vec" (:pie::sym "%E") (:pie::sym "k"))))))
                                  (:pie::t2 "->" (:pie::t2 "%mot" (:pie::sym "k") (:pie::sym "t"))
                                                 (:pie::t2 "%mot" (:pie::t1 "add1" (:pie::sym "k")) (:pie::t2 "vec::" (:pie::sym "h") (:pie::sym "t"))))))))

(:wat::core::defn :pie::do-ind-vec [len <- :wat::WatAST t <- :wat::WatAST mot <- :wat::WatAST b <- :wat::WatAST s <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::cond
    ((:pie::tag? t "VVecNil") b)
    ((:pie::tag? t "VVecCons")
      (:wat::core::let [k (:pie::arg len 0)]
        (:pie::do-ap (:pie::do-ap (:pie::do-ap (:pie::do-ap s k) (:pie::arg t 0)) (:pie::arg t 1))
                     (:pie::do-ind-vec k (:pie::arg t 1) mot b s))))
    ((:pie::tag? t "VNeu")
      (:pie::t2 "VNeu" (:pie::do-ap (:pie::do-ap mot len) t)
                (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::sym "NIndVec") len (:pie::arg t 1) (:pie::arg (:pie::arg t 0) 0) mot b s))))
    (:else (:pie::fail "ind-Vec of a non-Vec"))))
...
(:wat::core::defn :pie::rb-type [used <- :pie::Names v <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::cond
    ...
    ((:pie::tag? v "VTrivial") (:pie::sym "Trivial"))
    ((:pie::tag? v "VAbsurd") (:pie::sym "Absurd"))
    ((:pie::tag? v "VEq")
...
(:wat::core::defn :pie::rb [used <- :pie::Names t <- :wat::WatAST v <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::cond
    ...
    ;; every Trivial is sole; a stuck Absurd reads back annotated, (the Absurd x)
    ((:pie::tag? t "VTrivial") (:pie::sym "sole"))
    ((:wat::core::if (:pie::tag? t "VAbsurd") (:pie::tag? v "VNeu") false)
      (:pie::t2 "the" (:pie::sym "Absurd") (:pie::rb-neu used (:pie::arg v 1))))
...
(:wat::core::defn :pie::rb-neu [used <- :pie::Names ne <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::cond
    ((:pie::tag? ne "NIndAbsurd")
      (:pie::t2 "ind-Absurd" (:pie::t2 "the" (:pie::sym "Absurd") (:pie::rb-neu used (:pie::arg ne 0))) (:pie::rb-type used (:pie::arg ne 1))))
    ...
    ((:pie::tag? ne "NIndVec")
      (:wat::core::let [ks (:pie::kids ne)
        ...
        (:pie::mk (:wat::core::Vector :- [:wat::WatAST]
                    (:pie::sym "ind-Vec")
                    (:pie::rb used (:pie::t0 "VNat") (:pie::nth ks 1))
                    (:pie::rb-neu used (:pie::nth ks 2))
                    (:pie::rb used (:pie::ind-vec-mot-type et) mot)
                    (:pie::rb used (:pie::do-ap (:pie::do-ap mot (:pie::t0 "VZero")) (:pie::t0 "VVecNil")) (:pie::nth ks 5))
                    (:pie::rb used (:pie::ind-vec-step-type et mot) (:pie::nth ks 6))))))
    ((:pie::tag? ne "NIndList")
...
(:wat::core::defn :pie::special? [h <- :wat::core::String] -> :wat::core::bool
  (:pie::member? (:wat::core::Vector :- [:wat::core::String] "lambda" "Pi" "Sigma" "->" "Pair" "cons" "car" "cdr" "add1" "quote" "the" "which-Nat" "iter-Nat" "rec-Nat" "List" "::" "rec-List" "Vec" "vec::" "head" "tail" "ind-Nat" "=" "same" "cong" "replace" "symm" "trans" "ind-List" "ind-Vec" "Either" "left" "right" "ind-Either" "ind-Absurd") h))
...
(:wat::core::defn :pie::synth-var [ctx <- :wat::WatAST name <- :wat::core::String] -> :wat::WatAST
  (:wat::core::cond
    ((:pie::member? (:wat::core::Vector :- [:wat::core::String] "Atom" "Nat" "Trivial" "Absurd") name) (:pie::t0 "VU"))
    ((:wat::core::= name "sole") (:pie::t0 "VTrivial"))
...
(:wat::core::defn :pie::synth-form [ctx <- :wat::WatAST env <- :wat::WatAST e <- :wat::WatAST h <- :wat::core::String] -> :wat::WatAST
  (:wat::core::cond
    ...
    ((:wat::core::= h "ind-Absurd")
      (:wat::core::let [tc (:pie::check ctx env (:pie::arg e 0) (:pie::t0 "VAbsurd"))
                        mc (:pie::check-type ctx env (:pie::arg e 1))]
        (:pie::syn (:pie::eval env mc) (:pie::t2 "ind-Absurd" tc mc))))
    ((:wat::core::= h "ind-Either")
    ...
    ((:wat::core::= h "ind-Vec")
      (:wat::core::let [lc (:pie::check ctx env (:pie::arg e 0) (:pie::t0 "VNat"))
                        lv (:pie::eval env lc)
                        ts (:pie::synth ctx env (:pie::arg e 1))
                        vt (:pie::syn-type ts)
                        used (:pie::used ctx)
                        none (:wat::core::Vector :- [:wat::core::String])]
        (:wat::core::cond
          ((:wat::core::not (:pie::tag? vt "VVec")) (:pie::fail (:wat::string::concat "ind-Vec needs a Vec, not " (:pie::show-type ctx vt))))
          ((:wat::core::not (:pie::alpha? (:pie::rb used (:pie::t0 "VNat") lv) (:pie::rb used (:pie::t0 "VNat") (:pie::arg vt 1)) none none))
            (:pie::fail (:wat::string::concat "ind-Vec's length " (:wat::core::ast->source (:pie::sugar (:pie::rb used (:pie::t0 "VNat") lv)))
                                              " is not the target's, " (:pie::show-type ctx vt))))
          (:else
            (:wat::core::let [et (:pie::arg vt 0)
                              mc (:pie::check ctx env (:pie::arg e 2) (:pie::ind-vec-mot-type et))
                              mv (:pie::eval env mc)
                              bc (:pie::check ctx env (:pie::arg e 3) (:pie::do-ap (:pie::do-ap mv (:pie::t0 "VZero")) (:pie::t0 "VVecNil")))
                              sc (:pie::check ctx env (:pie::arg e 4) (:pie::ind-vec-step-type et mv))]
              (:pie::syn (:pie::do-ap (:pie::do-ap mv lv) (:pie::eval env (:pie::syn-core ts)))
                         (:pie::mk (:wat::core::Vector :- [:wat::WatAST] (:pie::sym "ind-Vec") lc (:pie::syn-core ts) mc bc sc))))))))
    ((:wat::core::= h "ind-List")
      (:wat::core::let [ts (:pie::synth ctx env (:pie::arg e 0))
                        lt (:pie::syn-type ts)]
    ...
    ((:wat::core::= h "cong")
      (:wat::core::let [ts (:pie::synth ctx env (:pie::arg e 0))
                        tt (:pie::syn-type ts)
                        fs (:pie::synth ctx env (:pie::arg e 1))
                        ft (:pie::syn-type fs)
                        used (:pie::used ctx)]
        (:wat::core::cond
          ((:wat::core::not (:pie::tag? tt "VEq")) (:pie::fail (:wat::string::concat "cong needs an equality, not " (:pie::show-type ctx tt))))
          ((:wat::core::not (:pie::tag? ft "VPi")) (:pie::fail (:wat::string::concat "cong needs a function, not " (:pie::show-type ctx ft))))
          ((:wat::core::not (:pie::alpha? (:pie::rb-type used (:pie::arg ft 1)) (:pie::rb-type used (:pie::arg tt 0))
                                          (:wat::core::Vector :- [:wat::core::String]) (:wat::core::Vector :- [:wat::core::String])))
            (:pie::fail (:wat::string::concat "cong's function takes " (:pie::show-type ctx (:pie::arg ft 1)) ", not " (:pie::show-type ctx (:pie::arg tt 0)))))
          (:else
            (:wat::core::let [x (:pie::arg tt 0)
                              y (:pie::inst (:pie::arg ft 2) (:pie::arg tt 1))
                              fv (:pie::eval env (:pie::syn-core fs))]
              (:pie::syn (:pie::t3 "VEq" y (:pie::do-ap fv (:pie::arg tt 1)) (:pie::do-ap fv (:pie::arg tt 2)))
                         (:pie::t4 "cong" (:pie::syn-core ts) (:pie::rb-type used x) (:pie::rb-type used y) (:pie::syn-core fs))))))))
    ((:wat::core::= h "ind-Nat")
...
(:wat::core::defn :pie::type-at [ctx <- :wat::WatAST env <- :wat::WatAST e <- :wat::WatAST u? <- :wat::core::bool] -> :wat::WatAST
  (:wat::core::let [h (:pie::head e)
    ...
    (:wat::core::cond
      ...
      ((:pie::member? (:wat::core::Vector :- [:wat::core::String] "U" "Atom" "Nat" "Trivial" "Absurd") n) e)
      ...
      ((:wat::core::= h "=")
        (:wat::core::let [xc (:pie::type-at ctx env (:pie::arg e 0) u?)
                          xv (:pie::eval env xc)]
          (:pie::t3 "=" xc (:pie::check ctx env (:pie::arg e 1) xv) (:pie::check ctx env (:pie::arg e 2) xv))))
    ...
    (:wat::core::cond
      ...
      ((:wat::core::if (:wat::core::= h "same") (:pie::tag? t "VEq") false)
        (:wat::core::let [x (:pie::arg t 0)
                          ec (:pie::check ctx env (:pie::arg e 0) x)
                          used (:pie::used ctx)
                          nf (:pie::rb used x (:pie::eval env ec))
                          from (:pie::rb used x (:pie::arg t 1))
                          to (:pie::rb used x (:pie::arg t 2))
                          none (:wat::core::Vector :- [:wat::core::String])]
          (:wat::core::if (:wat::core::if (:pie::alpha? from nf none none) (:pie::alpha? nf to none none) false)
            (:pie::t1 "same" ec)
            (:pie::fail (:wat::string::concat "same: " (:wat::core::ast->source (:pie::sugar nf)) " is not both "
                                              (:wat::core::ast->source (:pie::sugar from)) " and " (:wat::core::ast->source (:pie::sugar to)))))))
