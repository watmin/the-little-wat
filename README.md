...
- [FINDINGS.md](FINDINGS.md) is the ledger: every place wat fell short, or didn't.
  - F-001 to F-094 are gaps and defects.
  - R-001 to R-005 are deliberate refusals, with their doctrine.
  - C-001 to C-048 are clean ports and acceptance results.
...
probes/                             338 small programs, each isolating one question (the repros behind FINDINGS)
