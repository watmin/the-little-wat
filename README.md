...
guile) and 5 Advent of Code puzzles (10 answers against Clojure) pass (`./run.sh`), and the 11
...
probes/                             268 small programs, each isolating one question (the repros behind FINDINGS)
