...
- [FINDINGS.md](FINDINGS.md) is the ledger: every place wat fell short, or didn't.
  - F-001 to F-082 are gaps and defects.
  - R-001 to R-005 are deliberate refusals, with their doctrine.
  - C-001 to C-043 are clean ports and acceptance results.
...
probes/                             325 small programs, each isolating one question (the repros behind FINDINGS)
