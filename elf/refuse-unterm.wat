;; elf/refuse-unterm.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A string the file ends inside, inside a list. The end of input was read as the string's end,
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/reader-unterminated-string.wat" "elf/out/bad.elf"))
