;; elf/refuse-unclosed.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. One `)` too few. The end of the file used to close the list silently and the program ran
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/reader-missing-rparen.wat" "elf/out/bad.elf"))
