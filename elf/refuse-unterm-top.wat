;; elf/refuse-unterm-top.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A string the file ends inside, at the top level. It used to read as a complete string; it
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/reader-unterminated-string-top.wat" "elf/out/bad.elf"))
