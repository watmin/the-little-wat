;; grow80000.wat, with ONE difference: the accumulator goes through a user function on the way
...
(wat.core/defn user/main [] :- wat.type/nil
  (wat.kernel/println (user/grow 80000 (wat.core/Vector :- [wat.type/i64]))))
