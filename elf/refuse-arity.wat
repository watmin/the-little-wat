;; elf/refuse-arity.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A call with the wrong number of arguments used to COMPILE: the stack stayed balanced and
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/bad/arity.wat" "elf/out/bad.elf"))
