;; elf/refuse.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. It must die naming the form it could not compile.
;;
