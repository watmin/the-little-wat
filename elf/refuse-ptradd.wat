;; elf/refuse-ptradd.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A String is an address, and adding to one is not arithmetic. The type pass always knew
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/bad/ptradd.wat" "elf/out/bad.elf"))
