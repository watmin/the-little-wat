;; elf/refuse-rparen.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. One `)` too many. The reader read it as an atom ZERO bytes long and asked again at the same
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/reader-extra-rparen.wat" "elf/out/bad.elf"))
