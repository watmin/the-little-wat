;; elf/refuse-mismatch.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A `)` where `]` belongs. A list closes with its own closer or not at all (F-205); it must be
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/reader-mismatched-closer.wat" "elf/out/bad.elf"))
