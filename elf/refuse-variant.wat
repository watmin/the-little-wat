;; elf/refuse-variant.wat -- the compiler's NEGATIVE test: the same compiler, pointed at a program
;; it cannot translate. A None where a Some is wanted. A variant is assignable to its enum and to nothing else, and
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:c::compile "elf/probe/variant-param-wrong.wat" "elf/out/bad.elf"))
