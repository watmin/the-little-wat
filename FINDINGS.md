...
- **No laziness in this chapter**, so no P-027 stand-in and no Impure carriers — every type is a
  Pure enum.
- **This is a real capability and worth knowing.** It is the sort of thing a type system either
  has or does not, it is rarely mentioned in wat's docs, and it is what makes Okasaki's Part III
  portable at all.
- **Class:** CLEAN.
