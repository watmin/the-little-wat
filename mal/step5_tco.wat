;; mal/step5_tco.wat: Make-a-Lisp step 5, tail calls: step 4 unchanged, its tail calls wat's own.
;;
...
;; mal's own runner through tools/mal-shim.py (tools/mal-test.sh step5_tco): each input
