;; mal/step7_quote.wat: Make-a-Lisp step 7: quote, quasiquote, and cons, concat and vec.
;;
;; Step 6, plus quote and quasiquote. quasiquote is expanded as the process guide expands it,
;; into calls of cons, concat and vec (lib/core.wat), and the expansion is then evaluated.
;; Driven by mal's own runner through tools/mal-shim.py (tools/mal-test.sh step7_quote): each
