;; vr-count-10000.wat: very-recursiveo's search, 10000 answers COUNTED (no Vector accumulator).
;; Compare vr-take-10000.wat, which conj's each state onto a Vector.
...
(wat.core/defn user/main [] :- wat.type/nil
  (wat.kernel/println (u/count 10000 0 ((rs/very-recursiveo) (rs/start)))))
