;; vr-take-20000.wat: very-recursiveo's search alone, 20000 answers counted as states, no reification.
...
(wat.core/defn user/main [] :- wat.type/nil
  (wat.kernel/println (wat.core/length (rs/take 20000 [] ((rs/very-recursiveo) (rs/start))))))
