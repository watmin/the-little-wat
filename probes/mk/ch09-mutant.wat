;; ch09-mutant.wat: ch09-thin-ice.wat with ONE expected value made wrong (onceo answers (tea), not
;; (cup)), to prove the chapter's checks really run. Expected: fails at that assert-eq.
...
(:wat::load-file! "../../books/reasoned-schemer/lib/ch01-playthings.wat")
(:wat::load-file! "../../books/reasoned-schemer/lib/ch06-the-fun-never-ends.wat")
(:wat::load-file! "../../books/reasoned-schemer/lib/ch09-thin-ice.wat")
...
(wat.core/defn user/main [] :- wat.type/nil
  (wat.core/do
    ...
    (wat.test/assert-eq (rs/run* x (rs/onceo (rs/teacupo x))) '(cup))
