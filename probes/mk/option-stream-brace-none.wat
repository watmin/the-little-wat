;; option-stream-brace-none.wat: a lazy stream of Option values, where None is a pause
;; (miniKanren's suspension). None is written as the constructor (:wat::core::Option.None {}).
;; Expected: 42
