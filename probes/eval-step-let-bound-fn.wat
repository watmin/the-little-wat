...
;; Expected: 43, stepped -- HUNG before (a step returned its own input).
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:user::show "b4 let-bound fn      " (:wat::core::quote (:wat::core::let [x 42 f (:wat::core::fn [y <- :wat::core::i64] -> :wat::core::i64 (:wat::core::+ x y))] (f 1)))))
